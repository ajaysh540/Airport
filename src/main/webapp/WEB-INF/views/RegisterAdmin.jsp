...
<table class="table">
		<tr>
			...
			<th class="name"> ADMIN REGISTRATION
			</th>
			<th class="logout">
...
<h1>Admin Register</h1><br>
	<form action="/AirportManagement/app/AdminRegister" method="post">
		...
		<br><br>
		<input class="input"  type="date" name="dob" Placeholder="DOB" required>*
		<br><br>
		...
		<br><br>
		<input class="input"  name="contact" type="number" placeholder="Contact" required>*
		<br><br>
		<input class="input"  name="altcontact" type="number" placeholder="Alt Contact">
		<br><br>
		<input class="input"  type="password" name="password" Placeholder="password" required>*
		<br><br>
		<input class="input"  name="submit" value="Submit" type="submit">
		<br><br></form>
